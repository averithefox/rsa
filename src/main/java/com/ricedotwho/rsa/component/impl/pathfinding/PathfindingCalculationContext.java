...
public record PathfindingCalculationContext(Pos startPos, int threadCount, float yawStep, float pitchStep,
                                            float newNodeCost, float heuristicThreshold, boolean fullBlocks) {
