...
public class LookRing extends Ring implements Accessor {
    ...
    public LookRing(Pos min, Pos max, ArgumentManager manage, SubActionManager actions) {
        this(min, max, mc.gameRenderer.getMainCamera().yaw(), mc.gameRenderer.getMainCamera().getXRot(), manage, actions);
    }
