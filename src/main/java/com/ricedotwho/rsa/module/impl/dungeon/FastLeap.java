...
public class FastLeap extends Module {
  ...
  public void onChat(ChatEvent.Chat event) {
    if (!Location.getArea().is(Island.Dungeon) || !(Dungeon.isStarted() || Dungeon.isInBoss()) || !chatCommand.getValue())
      return;
  ...
  public static boolean doLeapFromOpenMenu(String leap) {
    if (mc.player == null || !(mc.player.containerMenu instanceof ChestMenu menu) || mc.screen == null || !mc.screen.getTitle().getString().equals("Spirit Leap"))
      return false;
