...
public class Relics extends Module {
  ...
  public void onSendPacket(PacketEvent.Send event) {
    if (!(event.getPacket() instanceof ServerboundInteractPacket packet) || mc.player == null || !look.getValue() || !Location.getArea().is(Island.Dungeon) || !DungeonUtils.isPhase(Phase7.P5) || !Dungeon.isInBoss() || hasRelic())
      return;
  ...
  public void onPollInputs(InputPollEvent event) {
    if (!walk || !Location.getArea().is(Island.Dungeon) || !DungeonUtils.isPhase(Phase7.P5) || !Dungeon.isInBoss())
      return;
  ...
  public void onTick(ClientTickEvent.Start event) {
    ...
    if ((!Location.getArea().is(Island.Dungeon) || !DungeonUtils.isPhase(Phase7.P5) || (Location.getFloor() != Floor.M7)) || !Dungeon.isInBoss())
      return;
