...
public enum AwaitType {
  CLICK(AwaitClick.class, "awaitClick", new TypeToken<AwaitClick>() {
  }.getType()), SECRETS(AwaitSecrets.class, "awaitSecrets", new TypeToken<AwaitSecrets>() {
  }.getType()), ETHERWARP_TRACE(AwaitEWRaytrace.class, "awaitEWRaytrace", new TypeToken<AwaitEWRaytrace>() {
  }.getType());
