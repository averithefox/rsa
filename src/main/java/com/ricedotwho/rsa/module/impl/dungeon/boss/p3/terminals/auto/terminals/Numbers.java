...
//                ChatUtils.chat("Update prediction index : " + slot.index);
    ...
    return getTerminalState(TerminalType.NUMBERS, infos);
  }
  ...
  public void solve() {
    super.solve();
    List<SolutionClick> sortedSlots = this.getTerminalContainer().slots.stream()
    ...
    this.setSolution(new Solution(sortedSlots));
  ...
  public static Numbers supply(ClientboundOpenScreenPacket packet, AbstractContainerMenu menu) {
