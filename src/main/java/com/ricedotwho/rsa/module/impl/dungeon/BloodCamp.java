...
public class BloodCamp extends Module {
  ...
  public void onEntityMove(PacketEvent.Receive event) {
    ...
    if (!packet.hasPosition() || packet.getXa() == (short) 0 && packet.getYa() == (short) 0 && packet.getZa() == (short) 0 || mc.level == null || mc.player == null || !Dungeon.isStarted() || Dungeon.isInBoss() || currentWatcher == null)
      return;
  ...
  public void onTick(ClientTickEvent.Start event) {
    if (mode.is("Off") || toClick == null || firstSpawns || Map.getCurrentRoom() == null || Map.getCurrentRoom().getData().type() != RoomType.BLOOD)
      return;
    if (!toClick.entity.isAlive()) {
      toClick = null;
      return;
